...
export const Volunteers: React.FC = () => {
  return (
    <div className="pt-40 pb-20 min-h-screen flex flex-col items-center justify-center text-center px-4">
      ...
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 font-heading">Our Volunteers</h1>
      <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
        A tribute to the dedicated volunteers who make our relief operations possible. List coming soon.
      </p>
    </div>
  );
};